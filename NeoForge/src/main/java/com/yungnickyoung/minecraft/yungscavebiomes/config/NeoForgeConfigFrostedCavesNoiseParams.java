...
public class NeoForgeConfigFrostedCavesNoiseParams {
    ...
    public NeoForgeConfigFrostedCavesNoiseParams(final ModConfigSpec.Builder BUILDER) {
        BUILDER.push("Biome Noise Parameters");

        temperatureMin = BUILDER
                .worldRestart()
                .defineInRange("Temperature Min", -1.0, -1, 1);

        temperatureMax = BUILDER
                .worldRestart()
                .defineInRange("Temperature Max", -0.7, -1, 1);
        ...
        continentalnessMin = BUILDER
                .worldRestart()
                .defineInRange("Continentalness Min", -0.19, -1, 1);
